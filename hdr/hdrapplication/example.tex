...
% CITATIONS
% The first parameter is the identifier of the category of publications.
% The second parameter is the label of the citation type.
% If empty, the default label is used.
% The third parameter is the BibTeX file in which the publication details may be found.
\declarebibliopre{ICB}{}{bibexample}% International Conferences with Reading Committee BEFORE PhD thesis
\declarebibliopre{NCB}{}{bibexample}% National Conferences with Reading Committee BEFORE PhD thesis
\declarebibliopost{JA}{}{bibexample}% International Journals with Reading Committee AFTER PhD thesis
\declarebibliopost{CA}{}{bibexample}% Chapters of book AFTER PhD thesis
\declarebibliopost{ICALN}{}{bibexample}% International Journals with Reading Committee and in Lecture Notes AFTER PhD thesis
\declarebibliopost{ICA}{}{bibexample}% International Conferences with Reading Committee AFTER PhD thesis
\declarebibliopost{NCA}{}{bibexample}% National Conferences with Reading Committee AFTER PhD thesis
\declarebibliopost{NCAW}{}{bibexample}% National Conferences without Reading Committee AFTER PhD thesis
\declarebibliopost{OA}{}{bibexample}% Other publications AFTER PhD thesis
...
\nociteJA{CossentinoGaudHilaireGallandKoukam2010_1} % Paper in international journal
\nociteJA{GaudGallandGechterHilaireKoukam2008_2} % Paper in international journal
\nociteJA{GaudGallandGechterHilaireKoukam2008_2} % Paper in international journal
\nociteICA{GallandGaudKoukam2008_3} % Paper in international conference.
