...
\declarethesis[Official Documentation]{SPIM-UFC PhD Thesis Style Extension for tex-upmethodology}{17 septembre 2012}{UPM-2012-01}
...
\thesisabstract[english]{This document describes the style extension for \texttt{tex-upmethodology} which is providing the standard document layout and colors of the PhD Thesis from the SPIM doctoral school and the Universit\'e de Franche-Comt\'e, France.}

\thesisabstract[french]{Ce document d\'ecrit l'extension de \texttt{tex-upmethodology} d\'edi\'ee au standard graphique des th\`eses de doctorat de l'\'Ecole Doctole SPIM et de l'Universit\'e de Franche-Comt\'e, France.}
