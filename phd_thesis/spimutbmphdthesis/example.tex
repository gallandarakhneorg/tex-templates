...
%% Uncomment only for SPIM-UTBM, change the language
...
%% Include a chapter with the publications of the author only.
%% CAUTION:
%% There is no standard way to do include this type of
%% personnal bibliography.
%% You could use 'multibib' package to help you, for example.
 
%% Define a "type" of bibliography, here the PERSONAL.
%\newcites{PERSO}{Liste des mes publications}
...
%% Link the PERSONAL bibliogaphy to a BibTeX file
%% (may be the same as the general bibliography one).
