...
\declaredocument{utbmciad Style Extension for tex-upmethodology}{Official Documentation}{UTBMCIAD-2026-03}
...
\setdocabstract{This document describes the style extension for \texttt{tex-upmethodology} which is providing the standard document layout and colors of the Laboratory ``Connaissance et Intelligence Artificielle Distribu\'ees'' from the Universit\'e de Technologie Belfort-Montb\'eliard, France.}

\updateversion{1.0}{\makedate{05}{08}{2019}}{First version of the documentation.}{\upmpublic}
\updateversion{2.0}{\makedate{09}{01}{2025}}{Remove UBFC.}{\upmpublic}
\updateversion{3.0}{\makedate{06}{04}{2026}}{Add funding scheme features.}{\upmpublic}
\updateversion{4.0}{\makedate{10}{04}{2026}}{Add color for watermark.}{\upmpublic}
...
\texttt{tex-upmethdology-utbmciad} provides the following macros:
\begin{itemize}
...
Copyright \copyright 2009, 2012-2026 Universit\'e de Technologie de Belfort-Monb\'eliard. All rights reserved. \\
