\documentclass[english,sectioncirclenumberstyle,showbackgroundpicture]{ciadbeamer}
...
\pgfdeclareimage[height=.25cm]{fakeciadlogointitle}{ciadlogoinv}
\pgfdeclareimage[height=.25cm]{fakeutbmlogointitle}{utbmlogoinv}
\pgfdeclareimage[height=.25cm]{fakeublogointitle}{ublogoinv}
...
\newcommand{\fakeslide}[3][fakeciadlogointitle]{
	\framebox{\begin{minipage}{.4\paperwidth}
		\begin{picture}(0,90)
			...
			#3
			\put(85,-1){
				\pgfuseimage{fakeutbmlogoinpartners}\hspace{0.05cm}\hspace{0.05cm}\pgfuseimage{fakeublogoinpartners}\hspace{0.05cm}\pgfuseimage{fakeubfclogoinpartners}\hspace{0.05cm}\pgfuseimage{fakecarnotlogoinpartners}}
		\end{picture}
	\end{minipage}}
}
...
\begin{frame}[t]{Class Options \insertcontinuationtext}
	\begin{block}{Slide Background Picture}
		\begin{itemize}
		\item \texttt{showbackgroundpicture}: show the slide background picture (default)
		\item \texttt{hidebackgroundpicture}: hide the slide background picture
		\item A macro is described after for changing the background picture
		\end{itemize}
	\end{block}
	\vspace{1cm}
...
\begin{frame}{Change the image of the fancy title page}
	\begin{block}{Use a predefined image}
		\texttt{{\textbackslash}setciadtitlebackgrounda} \raisebox{-.5\height}{\resizebox{5cm}{!}{\pgfuseimage{CIADtitlebackground1}}} \\
		\texttt{\textbackslash{}pgfuseimage\{CIADtitlebackground1\}} \\
		\texttt{{\textbackslash}setciadtitlebackgroundb} \raisebox{-.5\height}{\resizebox{5cm}{!}{\pgfuseimage{CIADtitlebackground2}}} \\
...
\begin{frame}{Change the image of the fancy title page \insertcontinuationtext}
	\begin{block}{Use a predefined image}
		\texttt{{\textbackslash}setciadtitlebackgroundc} \raisebox{-.5\height}{\resizebox{5cm}{!}{\pgfuseimage{CIADtitlebackground3}}} \\
		\texttt{\textbackslash{}pgfuseimage\{CIADtitlebackground3\}} \\
		\texttt{{\textbackslash}setciadtitlebackgroundd} \raisebox{-.5\height}{\resizebox{2cm}{!}{\pgfuseimage{CIADtitlebackground4}}} \\
...
\begin{frame}{Change the image of the fancy title page \insertcontinuationtext}
	\begin{block}{Use a predefined image}
		\texttt{{\textbackslash}setciadtitlebackgrounde} \raisebox{-.5\height}{\resizebox{4cm}{!}{\pgfuseimage{CIADtitlebackground5}}} \\
		\texttt{\textbackslash{}pgfuseimage\{CIADtitlebackground5\}} \\
		\texttt{{\textbackslash}setciadtitlebackgroundf} \raisebox{-.5\height}{\resizebox{4cm}{!}{\pgfuseimage{CIADtitlebackground6}}} \\
...
\begin{frame}{Change the image of the fancy title page \insertcontinuationtext}
	\begin{block}{Use a predefined image}
		\texttt{{\textbackslash}setciadtitlebackgroundg} \raisebox{-.5\height}{\resizebox{4cm}{!}{\pgfuseimage{CIADtitlebackground7}}} \\
		\texttt{\textbackslash{}pgfuseimage\{CIADtitlebackground7\}} \\
		\texttt{{\textbackslash}setciadtitlebackgroundh} \raisebox{-.5\height}{\resizebox{4cm}{!}{\pgfuseimage{CIADtitlebackground8}}} \\
...
\begin{frame}{Change the image of the fancy title page \insertcontinuationtext}
	\begin{block}{Use a predefined image}
		\texttt{{\textbackslash}setciadtitlebackgroundi} \raisebox{-.5\height}{\resizebox{4cm}{!}{\pgfuseimage{CIADtitlebackground9}}} \\
		\texttt{\textbackslash{}pgfuseimage\{CIADtitlebackground9\}} \\
		\texttt{{\textbackslash}setciadtitlebackgroundj} \raisebox{-.5\height}{\resizebox{4cm}{!}{\pgfuseimage{CIADtitlebackground10}}} \\
...
\begin{frame}{Change the image of the fancy title page \insertcontinuationtext}
	\begin{block}{Use a predefined image}
		\texttt{{\textbackslash}setciadtitlebackgroundk} \raisebox{-.5\height}{\resizebox{4cm}{!}{\pgfuseimage{CIADtitlebackground11}}} \\
		\texttt{\textbackslash{}pgfuseimage\{CIADtitlebackground11\}} \\
		\texttt{{\textbackslash}setciadtitlebackgroundl} \raisebox{-.5\height}{\resizebox{4cm}{!}{\pgfuseimage{CIADtitlebackground12}}} \\
...
\begin{frame}{Change the image of the fancy title page \insertcontinuationtext}
	\begin{block}{Use a predefined image}
		\texttt{{\textbackslash}setciadtitlebackgroundm} \raisebox{-.5\height}{\resizebox{4cm}{!}{\pgfuseimage{CIADtitlebackground13}}} \\
		\texttt{\textbackslash{}pgfuseimage\{CIADtitlebackground13\}} \\
		\texttt{{\textbackslash}setciadtitlebackgroundn} \raisebox{-.5\height}{\resizebox{4cm}{!}{\pgfuseimage{CIADtitlebackground14}}} \\
...
\begin{frame}{Change the image of the fancy title page \insertcontinuationtext}
	\begin{block}{Use a predefined image}
		\texttt{{\textbackslash}setciadtitlebackgroundo} \raisebox{-.5\height}{\resizebox{4cm}{!}{\pgfuseimage{CIADtitlebackground15}}} \\
		\texttt{\textbackslash{}pgfuseimage\{CIADtitlebackground15\}} \\
		\texttt{{\textbackslash}setciadtitlebackgroundp} \raisebox{-.5\height}{\resizebox{4cm}{!}{\pgfuseimage{CIADtitlebackground16}}} \\
...
\begin{frame}{Change the image of the fancy title page \insertcontinuationtext}
	\begin{block}{Use a predefined image}
		\texttt{{\textbackslash}setciadtitlebackgroundq} \raisebox{-.5\height}{\resizebox{4cm}{!}{\pgfuseimage{CIADtitlebackground17}}} \\
		\texttt{\textbackslash{}pgfuseimage\{CIADtitlebackground17\}} \\
		\texttt{{\textbackslash}setciadtitlebackgroundr} \raisebox{-.5\height}{\resizebox{4cm}{!}{\pgfuseimage{CIADtitlebackground18}}} \\
...
\begin{frame}{Change the image of the fancy title page \insertcontinuationtext}
	\begin{block}{Use a predefined image}
		\texttt{{\textbackslash}setciadtitlebackgrounds} \raisebox{-.5\height}{\resizebox{4cm}{!}{\pgfuseimage{CIADtitlebackground19}}} \\
		\texttt{\textbackslash{}pgfuseimage\{CIADtitlebackground19\}} ``
		\texttt{{\textbackslash}setciadtitlebackgroundt} \raisebox{-.5\height}{\resizebox{4cm}{!}{\pgfuseimage{CIADtitlebackground20}}} \\
		\texttt{\textbackslash{}pgfuseimage\{CIADtitlebackground20\}}
	\end{block}
\end{frame}
...
\begin{frame}{Institute URL}
	...
	\vspace{1em}
	\item The default url is: \url{http://ciadlab.fr}
	\vspace{1em}
...
\begin{frame}[t]{Slide Title Coloring}
	...
	\item By default the title of a slide is rendered with two colors:
		\begin{itemize}
		\item The white color is used for the first part (as shown for the title of this slide); and
		\item The green color is used for the second part.
		\end{itemize}
	\item \emph{By default, only the first word of the title is part of the first part (colored in white)}
	\item If you would like to change the words in the first part (colored in white), you could enclose them with braces:
	\item Example:
		\begin{itemize}
...
\begin{frame}{Changing the Background Picture}
	\begin{itemize}
	\item A macro for changing the background picture is provided: \\
		\texttt{{\textbackslash}defineslidebackgroundpicture\{picture position y\}\{picture poxition y\}\{picture width\}\{picture name\}}
	\vspace{1em}
	\item The preivous macro changes the parameters that are used within the macro for showing the background picture: \\
		\texttt{{\textbackslash}insertslidebackgroundpicture}
	\vspace{1em}
	\item Reset to the background:
		\begin{itemize}
		\item \texttt{{\textbackslash}resetslidebackgroundpictureCIAD}
		\item \texttt{{\textbackslash}resetslidebackgroundpictureUTBMPOWER}
		\item \texttt{{\textbackslash}resetslidebackgroundpictureUTBMPEOPLE}
		\end{itemize}
	\end{itemize}
\end{frame}
...
\begin{frame}{Slide with a Single Figure}
	...
	\begin{center}
		\fakeslide{XyZ}{
			\put(30,5){\includegraphics[width=.55\linewidth]{ciadlogo}}
		}
	\end{center}
\end{frame}
