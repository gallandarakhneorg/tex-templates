...
\pgfdeclareimage[height=.2cm]{fakeciadlogoinpartners}{ciadlogo}
\pgfdeclareimage[height=.2cm]{fakeutbmlogoinpartners}{utbmlogo}
\pgfdeclareimage[height=.2cm]{fakeublogoinpartners}{ublogo}
...
\newcommand{\fakeslide}[3][fakeciadlogointitle]{
	\framebox{\begin{minipage}{.4\paperwidth}
		\begin{picture}(0,90)
			...
			#3				
			\put(107,-1){
				\pgfuseimage{fakeciadlogoinpartners}\hspace{0.05cm}\hspace{0.05cm}\pgfuseimage{fakeubfclogoinpartners}\hspace{0.05cm}}
		\end{picture}
	\end{minipage}}
}
