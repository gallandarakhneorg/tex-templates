...
\begin{frame}[t]{Class Options \insertcontinuationtext}
	...
	\begin{block}{Hyphenation}
		...
		\end{itemize}
	\end{block}
	\smaller\alertbox{All the options accepted by Beamer are also accepted.}
\end{frame}
...
\begin{frame}{Headline with a User-defined Logo}
	\begin{itemize}
	\item \texttt{{\textbackslash}useheaderlinewithuserlogo\{filename\}}: the default headline contains the given image.
	\end{itemize}
	\begin{center}
...
\begin{frame}{Slide with a Single ANIMATED Figure}
	...
	\item If you have included the AutoLaTeX package, the following macro enables you to display an animated figure on the entire space of a slide: \\
		\texttt{{\textbackslash}animatedfigureslide[options]\{Title\}\{file\}}
...
\begin{frame}{How to Create an ANIMATED Figure?}
	...
	\item Include the figure with: \texttt{{\textbackslash}includeanimatedfigure[options]\{texfilename\}}
	\end{enumerate}
\end{frame}
