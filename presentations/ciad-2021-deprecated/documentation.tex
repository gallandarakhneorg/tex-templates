...
\pgfdeclareimage[height=.2cm]{fakeubfcmemberlogoinpartners}{ubfcmembergraylogo}
...
\begin{frame}[t]{Class Options \insertcontinuationtext}
	\begin{block}{Footline}
		...
		\item \texttt{ubfcmemberlogo} and \texttt{noubfcmemberlogo}: enable or disable the logo of "Member of Universit\'e de Bourgogne-Franche-Comt\'e" in the foot line.
...
\begin{frame}{{Right-Arrow-Sequence} Arrow Options}
	...
	\item \texttt{decoration=\ensuremath{<}\TeX\ macros\ensuremath{>}}: \TeX\ macros that compose the decoration of the arrow
	\end{itemize}
\end{frame}
