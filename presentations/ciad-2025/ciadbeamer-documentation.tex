...
\begin{textvideoframe}{{Example of frame} with left text and right video}{fakevideo.mp4}{ciad-ciadlogo}
	This is the standard frame content. See the previous slide for an explanation \\[.5cm]
	\texttt{{\textbackslash}settextvideofooter\{XYZ\}} \\[.5cm]
	\texttt{{\textbackslash}begin\{textvideoframe\}} \\
	\texttt{~~\{Example of frame[...]\}} \\
	\texttt{~~\{fakevideo.mp4\}\{ciad-ciadlogo\}} \\
	\texttt{~~This is [...]} \\
	\texttt{{\textbackslash}end\{textvideoframe\}}
\end{textvideoframe}
...
\begin{frame}{{Wrapped Figure} on Side of Itemizes}
	...
	\end{itemize}
	\begin{example}\tiny
		\wrapfigure[width=.1\linewidth]{ciad-ciadlogo}
		\begin{itemize}
...
\begin{frame}[t]{Link to a Video}
	...
	\end{itemize}
	\begin{center}
		\videolink[width=.3\linewidth]{./ciadbeamer-documentation.tex}{ciad-ubelogo}
	\end{center}
\end{frame}
...
\begin{frame}[t]{Link to a Slide with an Picture}
	...
	\end{itemize}
	\begin{center}
		\picturegoto[width=.3\linewidth]{progressbartypes}{ciad-ubelogo}
	\end{center}
\end{frame}
