...
This software package, utbmciad-report, contains two distinct types of material:

1. LaTeX source code (all files that are under the `tex/` and `docs/` directories and any documentation source files).
...
When redistributing this package (e.g., on CTAN, a personal website, or a CDN), you must preserve the directory structure and all accompanying license files.  Users of the LaTeX code may remove the `logos/` directory without affecting their rights under the LGPLv3.
